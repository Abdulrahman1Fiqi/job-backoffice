        ...
        <div class="w-full mx-auto p-6 bg-white rounded-lg shadow">
          <!-- Company Details -->
            ...
            <div class="flex justify-end space-x-4 mb-6">
                <!-- Edit Button -->
           <a href="{{ route('job-vacancies.edit',['job_vacancy'=>$jobVacancy->id,'redirectToList'=>'false']) }}" class="inline-flex items-center px-6 py-2.5 bg-blue-500 text-white text-sm font-medium rounded-lg shadow-md hover:bg-blue-600 hover:shadow-lg transition duration-200">Edit</a>
              <!-- Delete Button -->
            ...
            <!-- Tabs Navigation -->
             <div class="mb-6">
                <ul class="flex space-x-4">
                    <li>
                        <a href="{{ route('job-vacancies.show',['job_vacancy' => $jobVacancy->id, 'tab'=>'applications']) }}" class="px-4 py-2 text-gray-800 font-semibold
                        {{ request('tab') == 'applications'|| request('tab') == ''  ? 'border-b-2 border-blue-500' : '' }}">Applications</a>
                    </li>
                </ul>
             </div>
